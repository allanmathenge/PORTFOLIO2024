...
const Navbar = () => {
  ...
  return (
    <header className="w-full px-32 py-8 dark:text-light font-medium flex items-center justify-between relative">
      <button
      ...
      <div className="min-w-[70vw] flex flex-col justify-between z-30 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32 items-center left-1/2 fixed top-1/2 -translate-x-1/2 -translate-y-1/2">
        <nav>
          <CustomLink href="/" title="Home" className="mx-4" />
          <CustomLink href="/about" title="About" className="mx-4" />
          <CustomLink href="/projects" title="Projects" className="mx-4" />
